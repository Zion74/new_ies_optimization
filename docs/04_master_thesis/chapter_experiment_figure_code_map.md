...
| T4-5 / E5 | 8784 h 全年证据与时间方法 | 建立不依赖失真代表期的正式边界路线 | D36–D39 失败证据；D40 全年优先合同；后续全年执行/严格分解模块 | D40 已冻结四架构 build-only Gate A 和三种储能全年求解 Gate B；只有三案均达 `0.1%` 或严格不可行，才能进入局部全年网格 |
