...
除明确写出完整路径外，本文件中的代码路径均相对于 `风光火+熔盐储热/tes_bess_boundary/`。D38–D43 失败已登记且 D43 不得重跑。D44 已恢复 TES R0/R1 严格下界 `254,860,566.6193158889 CNY`；BESS 下界保持。D45 Hybrid R0 双证书在冻结墙钟前仅完成 `20/24`、`16/24` 块，总 manifest `668fb0ea...`，状态 `no_strict_certificate`，不得重跑。D47 唯一正式 IPX 56/56 加权持久块已恢复 Hybrid R0 严格下界 `232,011,577.8359315691 CNY`，并覆盖 R1/原 MILP。D46 合同、源码、Gate A 与唯一正式总批次均已完成；总 manifest `8693722...`，BESS/TES/Hybrid 均为 `no_candidate_incumbent`，没有 Repair A/B、正式可行容量或上界。严格项目账户仍为 `0/16`，项目运行账户为 `0/4`；正式 TAC、新的结果前可行性恢复路线与 E2-E6 批量入口尚待完成。
...
| T4-5 / E5 | 8784 h 全年证据与时间方法 | 建立不依赖失真代表期的正式边界路线 | D36–D39 失败证据；D40/D41 合同与失败证据；D42 全链证据；D43 正式失败证据；D44 正式 TES 证书；D45 正式失败证据；D47 正式 Hybrid 证书；D46 Gate A/唯一正式失败证据 | D43、D45、D47、D46 均不得原样重跑。D44/D47 使三架构下界闭合；D46 三架构均未获得 incumbent，上界恢复数为 0。下一步须另立结果前可行性恢复合同，技术排序与批量扫描仍禁止 |
