...
| T4-5 / E5 | 8784 h 全年证据与时间方法 | 建立不依赖失真代表期的正式边界路线 | D36–D39 失败证据；D40 合同/代码/证据；D41 严格界—修复分解合同与待建模块 | D40 单体路线未通过；D41 已冻结 `R0/R1` 合法下界、168/336 h 候选轨迹、原始 8784 h 可行修复上界和父进程硬墙钟，下一步实现 Gate A |
