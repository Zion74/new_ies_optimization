...
- **服务器与当前准入**：OpenBayes 60 核 / 约 100 GB 内存，D46 正式批次结束后活动残留进程为 0；D43、D45、D47、D46 均不得原样重跑。BESS、TES、Hybrid 现均具有至少一个严格全年下界，但没有对应原 MILP 可行上界、容量或项目 TAC。下一步必须另立结果前可行性恢复合同；正式 E2–E4、gap 收缩、项目 TAC 和技术赢家继续阻断；
