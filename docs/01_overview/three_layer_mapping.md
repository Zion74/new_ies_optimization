...
| 第 4 章 BESS—TES 适用边界 | 应由哪一种储能提供灵活性 | E1-E6，含四架构、公平前沿、双边界图和 8784 h 验证 | 价值分解、ε 前沿、两张 regime map、全年验证 | D33–D37 已完成公开成本/容量/材料性/代表周/分块边界。原 D38 `0.80/0.70` 状态因无储能静态不可行而失败且非代表周漏选；R1 baseline 又发生代表期—全年可行性反转。D39 结果前冻结原六周加第 49/16 周，Gate A 八周数据和跨平台复现已通过；只有 Gate B/C 继续通过才恢复三状态预验证。公开组合与 `0/16`、`0/4` 证据门仍禁止杨凌项目赢家主张 |
