...
| 第 4 章 BESS—TES 适用边界 | 应由哪一种储能提供灵活性 | E1-E6，含四架构、公平前沿、双边界图和 8784 h 验证 | 价值分解、ε 前沿、两张 regime map、全年验证 | D33–D37 已完成公开成本/容量/材料性/代表周/分块边界；D38/R1/D39、D40–D43 的失败均保留。D44 与 D47 已使三架构严格下界门闭合。D46/D48-R1/D49 上界恢复数均为 0；D50 结果前合同只开放 BESS 全年耦合分块 primal 恢复，正式 gap、技术排序和 E2–E4 扫描继续阻断 |
