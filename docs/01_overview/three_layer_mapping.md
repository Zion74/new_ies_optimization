...
| 第 4 章 BESS—TES 适用边界 | 应由哪一种储能提供灵活性 | E1-E6，含四架构、公平前沿、双边界图和 8784 h 验证 | 价值分解、ε 前沿、两张 regime map、全年验证 | `tes_bess_boundary/` 已实现 fixed-capacity、寿命经济、BESS 正式子账本、TES 成本门禁、同 PCC 服务、D21–D23 风险/暴露包络、D26 严格缩放证书、D27 方向/符号重构、D28 多起点负筛查、D29 外送耦合上界紧化和 D30 物理可达域/年度服务联合紧化，并保留 D24 的 16 账户路线和 D25 的项目数据接收门。24 h 严格包络已精确闭合；336 h 最大上界经 D27/D29/D30 累计较 D26 收紧 `42.9474%` 至 `777,141.368858 MWh/a`，但外界仍宽。`0/16` 正式账户、`0/4` 项目接收账户、336 h 闭合、代表周和容量规划完成前，E1-E6 不启动 |
