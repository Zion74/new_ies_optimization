...
| 第 4 章 BESS—TES 适用边界 | 应由哪一种储能提供灵活性 | E1-E6，含四架构、公平前沿、双边界图和 8784 h 验证 | 价值分解、ε 前沿、两张 regime map、全年验证 | `tes_bess_boundary/` 已实现 fixed-capacity、公平服务、生命周期经济、严格数值/证据门，以及 D33/D34 的公开成本组合、内生容量与完整系统接缝；双窗口同服务样本和 1% 严格 ε 初筛已冻结。下一步以旧 `1,200 MWhth` 切片为分母预注册无量纲材料性网格，再做代表周预验证。公开组合只能支持受控机制/广义敏感性边界；`0/16` 正式账户和 `0/4` 项目账户闭合前，不得报告杨凌实际经济赢家 |
