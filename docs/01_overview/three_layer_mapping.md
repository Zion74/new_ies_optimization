...
| 第 4 章 BESS—TES 适用边界 | 应由哪一种储能提供灵活性 | E1-E6，含四架构、公平前沿、双边界图和 8784 h 验证 | 价值分解、ε 前沿、两张 regime map、全年验证 | `tes_bess_boundary/` 已实现 fixed-capacity、公平服务、生命周期经济、严格数值/证据门、D33/D34 公开成本与完整内生容量，以及 D35 材料性网格。自然服务在 5%/10% 门下折叠为无储能；严格服务保留 TES，Hybrid 均无 BESS，TES/Hybrid bounds 重叠。下一步是结构化代表周预验证；公开组合只能支持受控机制/广义敏感性边界，`0/16` 与 `0/4` 闭合前不得报告杨凌实际经济赢家 |
