...
| 第 4 章 BESS—TES 适用边界 | 应由哪一种储能提供灵活性 | E1-E6，含四架构、公平前沿、双边界图和 8784 h 验证 | 价值分解、ε 前沿、两张 regime map、全年验证 | `tes_bess_boundary/` 已实现 fixed-capacity、公平服务、生命周期经济、D33–D37 公开成本/容量/材料性/代表周/分块边界。原 D38 的 `H*=0.80/G*=0.70` 状态在 490 MW PCC 下有 36 h 热需求超过无储能静态上限，且全部已由代表周 4 覆盖；故原合同不能关闭，也不能写成代表周方法失败或项目技术赢家。公开组合仍只支持受控边界，`0/16` 与 `0/4` 闭合前不得报告杨凌实际经济赢家 |
