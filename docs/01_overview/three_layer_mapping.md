...
| 第 4 章 BESS—TES 适用边界 | 应由哪一种储能提供灵活性 | E1-E6，含四架构、公平前沿、双边界图和 8784 h 验证 | 价值分解、ε 前沿、两张 regime map、全年验证 | D33–D37 已完成公开成本/容量/材料性/代表周/分块边界；D38/R1/D39、D40、D41 与 D42 均已登记失败。D43 结果前合同已冻结，下一步先实现只读快照审计和离线 80 位证书器编排；当前不得读取正式 dual 生成结果。Hybrid、技术排序和 E2–E4 批量扫描继续禁止，这不证明 TES 不可行或 BESS 更优 |
