...
| 第 4 章 BESS—TES 适用边界 | 应由哪一种储能提供灵活性 | E1-E6，含四架构、公平前沿、双边界图和 8784 h 验证 | 价值分解、ε 前沿、两张 regime map、全年验证 | `tes_bess_boundary/` 已实现 fixed-capacity、公平服务、生命周期经济、严格数值/证据门，以及 D33 的公开聚合/分项 TES 成本组合和 BESS/TES 线性内生容量核。下一步把容量核接入双机 CHP/PCC、损失辅机、两个额定放能测试与 BESS 正式成本，完成四架构小样本和代表周预验证。公开组合只能支持敏感性机制/广义边界；`0/16` 正式账户和 `0/4` 项目账户闭合前，不得报告杨凌实际经济赢家 |
