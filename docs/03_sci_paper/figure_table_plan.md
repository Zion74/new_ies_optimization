...
| Tab S1 | `tab:solver_performance` | HiGHS MIP gap、时间、内存和失败重试 | E0-E6 | E0-D-18、D23、D26–D28 已有 24 h/336 h 验收；必须保留方向正确的 primal/dual、有限界标志、证人和方向/全局语义；E1-E6 批量性能待生成 |
...
7. 最后补充 Fig S1-S3、Tab S-E0D18、Tab S-E0D23、Tab S-E0D26、Tab S-E0D27、Tab S-E0D28 与 Tab S1。
