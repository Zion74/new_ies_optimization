...
| Tab 2 | `tab:storage_parameters` | 分列 BESS 功率/可用电量与 TES 端口/盐量/罐容、效率、寿命、更换和运维 | E0 | E0-D-14 已闭合 Rahman 价格 + Schmidt 寿命、AC 放电 VOM 与 5–100 MW PCS 口径；TES 正式成本及端口工程上限待关闭 |
