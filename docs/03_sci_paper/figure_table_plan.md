...
| Tab S-E0D49 | `tab:e0d49_fuel_projection_recovery` | 原始/投影/保留二元清单、燃料编码依赖、精确提升残差、候选与原成本 repair 资格 | E0/E5 | 合同和提交 `86a8b80e...` 的实现已冻结，本地 24 h toy 通过但 OpenBayes Gate A/正式数值尚无。只有精确提升和 clean 原模型 repair 均通过时才填写 BESS 工程数值上界；Gate A 与 toy 不进入上界列 |
...
7. 最后补充 Fig S1-S3、Tab S-E0D18、Tab S-E0D23、Tab S-E0D26、Tab S-E0D27、Tab S-E0D28、Tab S-E0D29、Tab S-E0D30、Tab S-E0D31、Tab S-E0D46、Tab S-E0D48、Tab S-E0D49 与 Tab S1。
