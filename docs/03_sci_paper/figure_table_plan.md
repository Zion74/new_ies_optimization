...
| Tab 2 | `tab:storage_parameters` | 分列 BESS 功率/可用电量与 TES 端口/盐量/罐容、效率、寿命、更换和运维 | E0 | Rahman BESS 关联证据单元及非电芯成本映射已落地；BESS 的寿命/更换、VOM 与 PCS 尺度化三项衔接、TES 正式成本及端口工程上限待关闭 |
