...
E0-D-40 已在任何新模型规模或求解结果出现前冻结真实 8784 h 全年优先路线。当前实现只提供无代表期 provenance 的服务提取、四架构 clean-process build-only 审计、完整容量上界/安装联动、线性扫描、单全年循环边界和 20 GiB/40 GiB 资源汇总；不创建求解器。源码/测试 SHA-256 分别为 `1110af20f9b300f171dfbd5c21882822f2fa932908dbced65cbfaee8dcc30f6a` 与 `8f61afc9b47782fac4e77f2e567e88d160b27362a360bd9a28df1a9308f5aac`。Windows 定向/完整回归为 `6/460 passed`；OpenBayes Gate A 与同步回归尚未运行。
