...
| `docs/03_sci_paper/e0_d49_physics_first_fuel_projection_primal_recovery_contract.md` | 保留物理二元的等权 Hamming、只投影 CHP 燃料编码位、逐时确定性精确提升、完整二元固定和原成本 LP 修复 | E0/E5 | 第 1–11 节已结果前冻结；首次正式阶段只授权 BESS。源码、测试、Gate A 与正式产物均尚未生成，当前不产生上界、gap、TAC 或技术排序 |
