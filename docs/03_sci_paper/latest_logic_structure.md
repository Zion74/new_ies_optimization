...
- E0-D-23 将两架构放入同一联合 MILP，在 D19 成本/弃电 cap 内重新开放整数模式并极小化/极大化逐时 PCC 的年化 L1 重分配。24 h 精确包络为 `26,009.981813–26,010.174929 MWh/a`，D22 选择值几乎位于最大端；336 h 最小可能值仅能约束在 `0–31,172.816468 MWh/a`，最大可能值在使用 D22 外部可行证人后约束为 `31,228.008145–983,262.066874 MWh/a`。因此 D23 排除了 24 h 的连续替代最优疑虑，但 336 h 在 900 秒合同下仍未数值闭合；
